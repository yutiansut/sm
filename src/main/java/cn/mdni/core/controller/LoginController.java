package cn.mdni.core.controller;
...
import cn.mdni.core.dto.OauthAccessTokenUser;
import cn.mdni.core.dto.StatusDto;
import cn.mdni.core.service.LoginService;
import cn.mdni.core.shiro.ShiroSSORealm;
...
/**
 * @Description: 用户登录/退出/授权/修改密码Controller
 * @Company: 美得你智装科技有限公司
 * @Author Paul
