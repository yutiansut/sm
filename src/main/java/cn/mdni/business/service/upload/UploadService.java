package cn.mdni.business.service.upload;

import cn.mdni.business.constants.PropertyHolder;
import cn.mdni.business.constants.UploadCategory;
 ...
 * <p>
 * 解决以下问题： <br />
 * 1. 用户可能上传了图片，但没有提交表单，那么用户之前上传过的图片就永远不会被访问到。这种图片应该被删除。 2.
 * 当富文本内容从数据库中删除时，富文本中图片路径对应的图片文件也应该被删除。 3.
...
public class UploadService {
	 ...
	 *
	 * @param tmpPath
	 *            文件临时路径。如/static-content/tmp/product/2014/09/04/1.jpg
	 * @return 如果tmpPath是临时路径，则返回新路径，如/static-content/product/2014/09/04/1.jpg。否则返回原路径tmpPath
	 */
	 ...
	 * 删除指定路径的单个文件
	 *
	 * @param saveRelatePath
	 *            上传文件的相对路径 例如：product/2012/11/12/1.jpg
	 */
