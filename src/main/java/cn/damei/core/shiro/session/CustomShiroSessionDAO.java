...
public class CustomShiroSessionDAO extends AbstractSessionDAO {
    ...
    private cn.damei.core.shiro.session.ShiroSessionRepository shiroSessionRepository;
    ...
    public cn.damei.core.shiro.session.ShiroSessionRepository getShiroSessionRepository() {
        return shiroSessionRepository;
    }

    public void setShiroSessionRepository(
            cn.damei.core.shiro.session.ShiroSessionRepository shiroSessionRepository) {
