...
import cn.damei.business.service.material.*;
...
public class ExportExcelController {
    ...
    public void metarialexport(HttpServletResponse resp, HttpServletRequest res, @RequestParam() String contractCode, @RequestParam() String type) {
        ...
        HSSFSheet sheet = workbook.createSheet("北京大美装饰设计有限公司");
        ...
        getHeader(sheet, 2, cellStyle3, "北京大美装饰设计有限公司");
        getHeader(sheet, 2, cellStyle3, "北京大美装饰设计有限公司");
        //查询客户合同
    ...
    public void change(HttpServletResponse resp,
        ...
        HSSFSheet sheet = workbook.createSheet("大美工程变更联系单（主材）");
        rownum = getHeader(sheet, rownum, cellStyle3, "大美工程变更联系单（主材）");
        String aaa = "";
        if (changeTime != null) {
...
//        }
    ...
    public void oldHouse(HttpServletResponse resp, @RequestParam() String contractCode, @RequestParam() String contractStatus) {
        HSSFWorkbook workbook = new HSSFWorkbook();
        HSSFSheet sheet = workbook.createSheet("大美（尊贵套餐）附加老房拆除项目报价单");
        ...
        CustomerContract customerContract = getCustomerContract(contractCode);
        int rownum = 0;
        rownum = getHeader(sheet, rownum, cellStyle3, "大美（尊贵套餐）附加老房拆除项目报价单");
        ...
        rownum = getHeader(sheet, rownum, "           您好，感谢您选择大美装饰设计有限公司推出的装修新模式！公司全体员工努力为您提供优质的服务！期待您随时为我们提供宝贵的意见，便于更好的让您省时、省心、省力、省钱！谢谢！");
        rownum = getHeader(sheet, rownum, cellStyle, "基本信息：");
