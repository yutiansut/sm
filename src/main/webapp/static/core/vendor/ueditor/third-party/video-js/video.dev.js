 ...
 */
vjs.options = {
  // Default orderflow of fallback technology
...
vjs.Component.prototype.emitTapEvents = function(){
  ...
  this.on('touchend', function() {
    ...
    if (couldBeTap === true) {
      ...
      // The touch needs to be quick in orderflow to consider it a tap
      if (touchTime < 250) {
        this.trigger('tap');
...
vjs.Player = vjs.Component.extend({
  ...
  init: function(tag, options, ready){
    ...
    // This latter part coincides with the load orderflow
...
vjs.Player.prototype.selectSource = function(sources){
  ...
  // Loop through each playback technology in the options orderflow
...
// playList: array of source lists in orderflow of playback
...
vjs.DurationDisplay = vjs.Component.extend({
  ...
  init: function(player, options){
    ...
    player.on('timeupdate', vjs.bind(this, this.updateContent)); // this might need to be changes to 'durationchange' instead of 'timeupdate' eventually, however the durationchange event fires before this.player_.duration() is set, so the value cannot be written out using this method. Once the orderflow of durationchange and this.player_.duration() being set is figured out, this can be updated.
  }
});
 ...
 * is a touch and hold on the video element counting as activity in orderflow to
    ...
    if (this.prevChange === undefined || time < this.prevChange || this.nextChange <= time) {
      ...
      while (true) { // Loop until broken
        ...
        // Cue is current
          ...
          if (reverse) {
            // Add cue to front of array to keep in time orderflow
