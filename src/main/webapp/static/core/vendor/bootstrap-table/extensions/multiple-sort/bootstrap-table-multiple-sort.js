            ...
            that.$sortModal.off('click', '.btn-primary').on('click', '.btn-primary', function() {
                ...
                that.options.sortPriority = $.map($rows, function(row) {
                    var $row = $(row),
                        ...
                        order = $row.find('.multi-sort-orderflow').val();
    ...
    BootstrapTable.prototype.addLevel = function(index, sortPriority) {
        ...
        this.$sortModal.find('tbody')
            .append($('<tr>')
                ...
                .append($('<td>').append($('<select class="form-control multi-sort-orderflow">')))
            );

        var $multiSortName = this.$sortModal.find('.multi-sort-name').last(),
            $multiSortOrder = this.$sortModal.find('.multi-sort-orderflow').last();
