            ...
            <div class="row">
                <form id="searchForm" @submit.prevent="query">
                    ...
                    <div class="col-md-2 form-group">
                        <input v-model="form.startDate" v-el:paystart-time id="paystartTime"
                               name="paystartTime" type="text" readonly
                               class="form-control datepicker" placeholder="变更完成开始时间">
                    </div>

                    <div class="col-md-2 form-group">
                        <input v-model="form.endDate" v-el:payend-time id="payendTime"
                    ...
                    <div class="col-md-2">
                        <div class="form-group" >
                           <select v-model="form.printCount"  class="form-control" >
                                <option value="" selected>--请选择打印状态--</option>
...
<script src="${ctx}/static/business/finance/print/changeList.js"></script>
